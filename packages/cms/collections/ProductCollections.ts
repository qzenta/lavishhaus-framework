...
// Named "product-collections" (not "collections") to avoid colliding with
// Payload's own "collections" terminology. Mirrors apps/lavishhaus's
// Collection type in types/catalog.ts.
